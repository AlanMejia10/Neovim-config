...
set showmatch matchtime=5 "shows the matching bracket
set cc=80 "set a column at 80 characters
...
" swap split panes
noremap <Leader><A-h> <C-w>H
noremap <Leader><A-j> <C-w>J
noremap <Leader><A-k> <C-w>K
noremap <Leader><A-l> <C-w>L
...
" suppor for ejs
au BufNewFile,BufRead *.ejs set filetype=htmlt
